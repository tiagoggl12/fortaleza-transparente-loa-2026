# GUIA COMPLETO DO BANCO VETORIAL LOA 2026

Este guia explica detalhadamente como utilizar o sistema de busca semântica construído para o LOA 2026 de Fortaleza.
...
├── GUIA_CHROMA.md             # Documentação completa
...
🏆 Status: {'OPERACIONAL' if taxa_sucesso >= 90 else 'NECESSÁRIA ATENÇÃO'}
""")
...
```bash
source venv/bin/activate
python GUIA_CHROMA.md  # Este documento como referência
```
